      ...
      <div className="container">
        ...
        <Reveal delay={100}>
          ...
          <div className="clinks">
            ...
            <a href="https://www.linkedin.com/in/ismail-ahmed-90210compeng" target="_blank" rel="noopener noreferrer" className="clink">
              <LinkedInIcon />
              linkedin.com/in/ismail-ahmed-90210compeng
            </a>
          </div>
        </Reveal>
